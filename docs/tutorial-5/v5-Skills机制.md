...
v4 给了我们子代理来分解任务。但还有一个更深的问题：**模型怎么知道如何处理特定领域的任务？**
...
| 版本   | 主题           | 新增行数 | 核心洞察                 |
| ------ | -------------- | -------- | ------------------------ |
| v2     | Model as Agent | ~200     | 模型是 80%，代码只是循环 |
| v3     | 结构化规划     | ~100     | Todo 让计划可见          |
| v4     | 分而治之       | ~150     | 子代理隔离上下文         |
| **v5** | **领域专家**   | **~100** | **Skills 注入专业知识**  |
